...
function takeCommand(message) {
    ...
    if (message.includes("hello sara") || message.includes("hey sara")|| message.includes("hey")|| message.includes("hello")|| message.includes("sara")) {
    ...
    else if (message.includes("sar who is my mother") || message.includes("my mother's name")|| message.includes("sara please tell me who is my mother")|| message.includes("can you tell me who is my mother")|| message.includes("sara can you tell me who is my mother")|| message.includes("can you tell me who is my mother sara")|| message.includes("do you know who is my mother")|| message.includes("sara do you know who is my mother")|| message.includes("do you know who is my mother sara")|| message.includes("do you know my mother")|| message.includes("sara do you know my mother")|| message.includes("do you know my mother sara")) {
